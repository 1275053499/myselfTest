 ...
 *  代理
 */
@protocol YJLscrollDelegate <NSObject>
...
#pragma mark  图片类型 可以是本地图片（UIImage，不能是图片名称），也可以是网络路径
/**
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<YJLscrollDelegate> yjlscrollDelegate;
